...
/**
 * Title: page-homepage
 * Slug: domki-dobre-miejsce/page-homepage
 * Inserter: no
 */
?>
<!-- wp:template-part {"slug":"header"} /-->

<!-- wp:domki-hero/domki-hero {"identifier":"hero","links":[{"text":"O nas","url":"#onas","order_by":1},{"text":"Video","url":"#video","order_by":2},{"text":"galeria","url":"#galeria","order_by":3},{"text":"Atrakcje dla dzieci","url":"#atrakcjedladzieci","order_by":4},{"text":"Atrakcje w okolicy","url":"#atrakcjewokolicy","order_by":5},{"text":"Oferta","url":"#oferta","order_by":6},{"text":"Kontakt","url":"#kontakt","order_by":7}],"logo":{"media_id":361,"alt":""},"images":[{"media_id":635,"text":"Atrakcje","alt":"","order_by":1},{"media_id":25,"text":"Atrakcjesssss","alt":"","order_by":2},{"media_id":31,"text":"ddddddddddd","alt":"","order_by":3}],"carousel":{"autoplay":"3000","loop":true}} /-->
