...
$menu_fixed = isset($attributes["fixed"]) ? $attributes["fixed"] : false;

$menu_fixed_classes = $menu_fixed ? "menu-fixed hide-on-small" : "menu-fixed hide-on-small show-menu-fixed";
...
<div <?php echo get_block_wrapper_attributes(); ?> data-wp-interactive="domki-navbar" <?php echo wp_interactivity_data_wp_context([
		...
		"isMenuFixed" => boolval($menu_fixed)
	]); ?>
	data-wp-on-document--scroll="callbacks.handleScroll" data-wp-watch="callbacks.watchMobileMenu"
	...
	<!-- show-menu-fixed -->
	<div class="<?php echo esc_attr($menu_fixed_classes); ?>">
		<div class="menu-container">
			<section class="left">
				...
				<a title="Domki dobre miejsce - strona główna" href="<?php echo esc_url(home_url()) ?>"
